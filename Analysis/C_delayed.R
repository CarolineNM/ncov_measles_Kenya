...
for(i in 1:5000){
  ...
  save(out_20,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_20.Rdata")
  
}


data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_20.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for(i in 1:5000){ 
  ...
  save(out_21,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_21.Rdata")
  
}
##year 22 is nov 2019
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_21.Rdata"))
...
for(i in 1:5000){
  ...
  save(out_22,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_22.Rdata")
  
}


##year 23 is Dec 2019
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_22.Rdata"))
...
for(i in 1:5000){
  ...
  save(out_23,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_23.Rdata")
  
}


##year 24 is Jan 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_23.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_24,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_24.Rdata")
  
}

##year 25 is Feb 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_24.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_25,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_25.Rdata")
  
}

##year 26 is Mar 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_25.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_26,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_26.Rdata")
  
}

##year 27 is Apr 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_26.Rdata"))
...
for (i in 1:5000){
  ...
  cvm_27[[i]] <- cbind(cvm_26[[i]], 0.5*(cvm_26[[i]][, ncol(cvm_26[[i]])]))   ##ScenarioA same coverage
  ...
  save(out_27,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_27.Rdata")
  
}

##year 28 is May 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_27.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_28,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_28.Rdata")
  
}

##year 29 is June 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_28.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_29,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_29.Rdata")
}

##year 30 is July 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_29.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_30,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_30.Rdata")
  
}

##year 31 is Aug 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_30.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_31,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_31.Rdata")
  
}

##year 32 is sep 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_31.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_32,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_32.Rdata")
  
}

##year 33 is oct 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_32.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_33,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_33.Rdata")
  
}

##year 34 is Nov 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_33.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_34,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_34.Rdata")
  
}

##year 35 is Dec 2020
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_34.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_35,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_35.Rdata")
  
}

##year 36 is Jan 2021
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_35.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_36,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_36.Rdata")
  
}

##year 37 is feb 2021
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_36.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_37,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_37.Rdata")
  
}

##year 38 is mar 2021
data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_37.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_38,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_38.Rdata")
  
}

##year 39 is Apr 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_38.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_39,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_39.Rdata")
  
}

##year 40 is May 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_39.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_40,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_40.Rdata")
  
}

##year 41 is jun 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_40.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_41,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_41.Rdata")
  
}

##year 42 is Jul 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_41.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_42,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_42.Rdata")
  
}

##year 43 is Aug 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_42.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_43,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_43.Rdata")
  
}

##year 44 is sep 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_43.Rdata"))
...
for (i in 1:5000){
  ...
  save(out_44,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_44.Rdata")
  
}

##year 45 is oct 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_44.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_45,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_45.Rdata")
  
}

##year 46 is Nov 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_45.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_46,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_46.Rdata")
  
}

##year 47 is Dec 2021

data=get(load("D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_46.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
...
for (i in 1:5000){
  ...
  save(out_47,file = "D:/MANUSCRIPT/ncov_measles_Kenya/C/delayed/out_47.Rdata")
